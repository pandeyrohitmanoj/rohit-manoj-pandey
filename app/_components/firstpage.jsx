...
import FileButtons from '../_components/fileButtons'
import styles from './styles.module.css'

import {OpacityAnimation} from './popUpAnimation'
export default function firstpage() {
  return (
    <section className='max-w-full' id='front-page-parent'>
      <section id='front-page' className={` min-h-5/6 w-full mb-40  tracking-widest`}>
        ...
        <OpacityAnimation duration={0.40}><article className={`${styles.roboto} font-normal text-center max-w-108 mt-10 mx-auto mb-10 px-4`}>Hi, I am Rohit Pandey, and I am a Next JS Developer with expertise in Cloud Dev, and  I use it to create awesome web apps.</article></OpacityAnimation>
