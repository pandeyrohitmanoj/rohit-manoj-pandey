...
import Project3 from '../../public/vscodeproject.png'
import Image from "next/image";
const projectsArray = [
  {
    name: "AI Code Assistant",
    description: "VS Code Assistant using React + Langchain",
    githubLink: "https://github.com/pandeyrohitmanoj/chess-mern.git",
    image: Project3,
    technology: ['VS Code Extension','LangChain', "FastAPI",'React JS','Express JS','HTML5','CSS3','Mongo DB','Google Cloud Storage','Framer Motion']
  },
  {
    name: "ShareDoc",
...
export default function projects() {
  return (
    <section id="projects" className="mb-28">
      ...
      <section className="flex justify-center items-stretch flex-wrap  gap-16 overflow-auto w-full mx-auto">
        {projectsArray.map((project, index) => {
          duration+=0.25
          return (
            <article
              className="flex flex-col items-stretch shadow-xl max-w-full gap-2 projectComponent hover:border hover:border-1 border-slate-100 rounded-xl overflow-hidden"
              key={index}
            >
              <OpacityAnimation duration={duration}>
                ...
                <section className="flex mx-5 my-3">
