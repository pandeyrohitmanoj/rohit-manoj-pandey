  ...
  return (
    <section>
      <CenteredImage  image={ComputerImage} alt="Hero-devices" height={350}  />
        ...
        <p className={`${roboto.className} font-normal text-xl`}>I have professional experience of 2 years, working as a full-stack developer at Infosys Ltd. India's second largest tech company.
